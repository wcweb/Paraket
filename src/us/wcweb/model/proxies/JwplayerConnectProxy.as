		...
		private function onStatus(e : StatusEvent) : void {
			switch (e.level) {
				case "status":
					...
					dispatch(new JwplayerConnectProxyEvent(JwplayerConnectProxyEvent.CONNECT_SUCCESS, "连接jwplayer成功"));
					break;
				case "error":
					trace("LocalConnection.send() failed");
					dispatch(new JwplayerConnectProxyEvent(JwplayerConnectProxyEvent.CONNECT_SUCCESS, "连接jwplayer失败"));
					break;
			}
		}
